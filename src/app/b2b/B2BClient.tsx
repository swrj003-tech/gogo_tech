...
export default function B2BClient() {
    ...
    // Handle smooth scrolling to section when hash is present
    useEffect(() => {
    ...
    return (
        <main id="b2b-page" className="min-h-screen bg-white">
            <Navbar />

            {/* B2B Hero */}
            <section id="fuel-delivery" className="relative bg-slate-900 text-white pt-32 pb-24 overflow-hidden">
            ...
            <section id="b2b-solutions" className="py-24 bg-slate-50 scroll-mt-20">
