...
const defaultSEO: Record<string, PageSEO> = {
    ...
    legal: {
        title: { en: "Legal - Privacy, Terms & Cookies", fr: "Mentions Légales - Confidentialité, CGU & Cookies" },
        description: {
            en: "Our privacy policy, terms of service, and cookie policy. Transparency and compliance are our priorities.",
            fr: "Notre politique de confidentialité, conditions d'utilisation et politique des cookies. Transparence et conformité sont nos priorités."
        }
    },
    contact: {
        title: { en: "Contact Us - GoGo Fuel Delivery", fr: "Contactez-nous - GoGo Livraison de Carburant" },
        description: {
            en: "Get in touch with GoGo. We're here to help with any questions or support you need. Available 24/7.",
            fr: "Contactez GoGo. Nous sommes là pour vous aider avec toutes vos questions. Disponible 24/7."
        }
    }
};
