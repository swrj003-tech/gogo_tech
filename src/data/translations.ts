...
export const dictionary = {
    en: {
        ...
        about: {
            ...
            description: "GoGo is our response to the promise of ingenuity: using technology to solve our own daily challenges. We don’t just deliver fuel; we deliver time and peace of mind.",
            cta: "Read our story",
        ...
        quote: {
            ...
            subtitle: "Join corporate partners who trust GoGo for reliable on-site fueling, maintenance, and detailed consumption analytics.",
            benefits: [
        ...
        aboutExtended: {
            ...
            description: "At GOGO Imperial Energy, our mission is to redefine fuel delivery. We combine cutting-edge technology with feet-on-the-street logistics to ensure you never run dry.",
        ...
        blog: {
            title: "GoGo Blog",
            subtitle: "Insights on fuel delivery, fleet management, and energy.",
        ...
        aboutPage: {
            ...
            heroDesc: "GoGo is our response to the promise of ingenuity: using technology to solve our own daily challenges. We don’t just deliver fuel; we deliver time and peace of mind.",
            originTitle: "Our Origin",
            whyStarted: "Why We Started",
            originText: "We all know the challenge: endless traffic jams, crowded or sometimes dry gas stations, and those precious minutes lost when we could be with our loved ones or at our offices. GoGo was born from a simple observation: if the world is changing, the way we supply ourselves with energy must change too. We created GoGo to meet a fundamental need for efficiency in our rapidly changing cities.",
            timeline: [
            ...
            mission: "Simplify the life of every driver and business through safe, smart, and sustainable energy delivery technology.",
            vision: "Become the number 1 reflex for mobility, by creating an ecosystem where energy and services come to the user, and not the other way around.",
            ...
            metrics: {
                innovation: { title: "Innovation", desc: "We do not copy foreign models; we adapt cutting-edge technology to the realities of our roads, our cities, and our economies. GoGo is a solution designed by local talents for the continent." },
            ...
            team: {
                title: "Meet Our Team",
                desc: "The passionate people behind GoGo, working to revolutionize energy delivery."
            }
        },
        trustPage: {
            title: "Trust & Support",
    ...
    fr: {
        ...
        b2b: {
            ...
            title: "Solutions B2B",
            subtitle: "Accédez à notre plateforme B2B pour la gestion des commandes, des tickets valeurs et des rapports.",
            ...
            sections: {
                ...
                platform: {
                    ...
                    description: "Notre plateforme B2B propriétaire vous offre transparence et contrôle sur vos dépenses énergétiques."
                },
                cta: {
        ...
        quote: {
            ...
            subtitle: "Rejoignez les partenaires qui font confiance à GoGo.",
            benefits: [
